...
import os
import re
os.environ['OPENAI_API_KEY'] = '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' # your openai key
...
def recommend():
    if request.method == "POST":
        ...
        breakfast_names.append('NO SPECIFIC RECOMMENDATIONS')
        dinner_names.append('NO SPECIFIC RECOMMENDATIONS')
        workout_names.append('NO SPECIFIC RECOMMENDATIONS')
        ...
        return render_template('result.html',breakfast_names=breakfast_names,dinner_names=dinner_names,workout_names=workout_names)
    return render_template('index.html')
